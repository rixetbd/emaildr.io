        ...
        let str1 = localStorage.getItem("firstName");
        let str2 = localStorage.getItem("lastName");
        let str3 = "@" + localStorage.getItem("domain");

        let a = str1.concat(str2, str3);
        let b = str1.concat(str3);
        let c = str2.concat(str3);
        let d = str2.concat(str1, str3);
        let e = str1.charAt(0);
        let f = str2.charAt(0);
        let dr = "dr";
